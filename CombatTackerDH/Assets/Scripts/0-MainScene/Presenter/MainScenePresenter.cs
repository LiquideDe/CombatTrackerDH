...
public class MainScenePresenter : IPresenter
{
    ...
    [Inject]
    private void Construct(AudioManager audioManager, Creators creators, LvlFactory lvlFactory, PresenterFactory presenterFactory)
    {
    ...
    public void Initialize(MainSceneView view, WeaponView weaponView)
    {
        _view = view;
